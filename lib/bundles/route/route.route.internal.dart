...
import 'package:inventory_management/bundles/material/advanced_info_page.dart';

class ARouterInternalImpl extends ARouterInternal {
  ARouterInternalImpl();
  final Map<String, List<Map<String, dynamic>>> innerRouterMap =
      <String, List<Map<String, dynamic>>>{
    'router://AdvancedInfoPage': [
      {'clazz': AdvancedInfoPage}
    ]
  };
  ...
  dynamic instanceFromClazz(Type clazz, dynamic option) {
    switch (clazz) {
      case AdvancedInfoPage:
        return new AdvancedInfoPage(option);
      default:
        return null;
    }
  }
